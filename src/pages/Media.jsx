                        ...
                        <div className="gallery-item">
                            ...
                            <div className="gallery-content">
                                <div className="gallery-inner pb-5">
                                    <Link className="h4 text-white">Beauty Of Life</Link>
                                    <Link className="text-white"><p className="mb-0">Bright Futures</p></Link>
                                </div>
                            </div>
                        </div>
                        <div className="gallery-item">
                            ...
                            <div className="gallery-content">
                                <div className="gallery-inner pb-5">
                                    <Link className="h4 text-white">Beauty Of Life</Link>
                                    <Link className="text-white"><p className="mb-0">Unity in Action</p></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="gallery-item">
                            ...
                            <div className="gallery-content">
                                <div className="gallery-inner pb-5">
                                    <Link className="h4 text-white">Beauty Of Life</Link>
                                    <Link className="text-white"><p className="mb-0">Strength in Unity</p></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="gallery-item">
                            ...
                            <div className="gallery-content">
                                <div className="gallery-inner pb-5">
                                    <Link className="h4 text-white">Beauty Of Life</Link>
                                    <Link className="text-white"><p className="mb-0">Green Initiatives</p></Link>
                                </div>
                            </div>
                        </div>
                        <div className="gallery-item">
                            ...
                            <div className="gallery-content">
                                <div className="gallery-inner pb-5">
                                    <Link className="h4 text-white">Beauty Of Life</Link>
                                    <Link className="text-white"><p className="mb-0">Rising Together</p></Link>
                                </div>
                            </div>
                        </div>
                    </div>
