      ...
      <div className="container-fluid event py-5">
        <div className="container px-5">
          <div className="text-center mx-auto mb-5" style={{ maxWidth: '800px' }}>
            <h5 className="text-uppercase headingred">Technical programs</h5>
            <h1 className="mb-0">We are currently offering Free Technical Courses!</h1>
            <img
              src='../assets/ngoImgs/m32.jpeg'
              class="card-img-top"
